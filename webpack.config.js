...
module.exports = env => {
  ...
  appComponents.push(
    ...[
      ...
      '/home/francesco/work/smart-collar/frontend/app/services/MyNotificationListener.ts',
      resolve(__dirname, 'app/services/MyNotificationListener'),
      resolve(__dirname, 'app/services/MyNotificationListener.ts'),
      './services/MyNotificationListener.ts',
      './services/MyNotificationListener',
    ],
  );
